from parser.ELO.team import Team
...
class ELO:
    ...
    def __init__(self, volatility: int = 150, gain_ceiling: int = 400):
        ...
        Args:
            ...
            gain_ceiling: The amount of elo difference two teams.txt can be before a winning team that doesn't win all
                rounds against a losing team beings to lose small amounts of elo. Effectively the amount difference in
                ELO between two teams.txt allowed before one of the two teams.txt loses elo even when losing in a small amount.
        """
    ...
    def _calculate_expected_score(self, team1_elo: int, team2_elo: int) -> float:
        ...
        Returns:
            The predicted score of the teams.txt
        """
